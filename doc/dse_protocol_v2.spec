...
4.2.5.2. Rows
  ...
  where:
    - <metadata> is composed of:
        <flags><columns_count>[<new_metadata_id>][<paging_state>][<continuous_page_no>][<global_table_spec>?<col_spec_1>...<col_spec_n>]
      where:
...
10.2. Changes from DSE binary protocol v1
  ...
  * Added result_metadata_id to Prepared response and EXECUTE request (sections 4.2.5.4, 4.1.6 and 4.2.5.2).
