 ...
 * sized "segments" ({@link com.datastax.apollo.nodesync.Segment}). It then validate segments by fully reading the
 * content of the range it represents from all alive replica and relying on the normal read-repair machinery to detect
 * and repair any inconsistencies (the next segment to validate is determined by {@link com.datastax.apollo.nodesync.ValidationScheduler}
 * which creates {@link com.datastax.apollo.nodesync.Validator} and pass then to {@link com.datastax.apollo.nodesync.ValidationExecutor}
