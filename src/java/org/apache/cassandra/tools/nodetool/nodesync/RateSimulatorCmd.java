...
public class RateSimulatorCmd extends NodeTool.NodeToolCmd
{
    ...
    private void printHelp()
    {
        ...
        print("has to deal with many imponderables. Typically, when a node fails, it won't");
        ...
        print("");
        print("Further, those recommended values are likely to be too low on new and almost");
        ...
        print("");
        print("Lastly, all simulations (all sub-commands) can also be influenced by the");
        ...
        print("    nonetheless. This allows to simulate the impact enabling NodeSync on those");
        ...
        print("    This allows to simulate the impact disabling NodeSync on those tables would");
        ...
        print("    owns. This option removes that assumption, computing a rate that takes the");
        print("    totally of the data the node stores into account.");
        print("  -do/--deadline-overrides=<overrides>: by default, the simulator considers each");
