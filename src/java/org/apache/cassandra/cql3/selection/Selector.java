...
public abstract class Selector
{
    ...
    {
        protected abstract Selector deserialize(DataInputPlus in, ReadVersion version, TableMetadata metadata) throws IOException;
    ...
    protected abstract int serializedSize(ReadVersion version);
