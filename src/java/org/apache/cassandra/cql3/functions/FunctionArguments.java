...
/**
 * Default {@code Arguments} implementation.
 */
final class FunctionArguments implements Arguments
{
    /**
     * An empty {@code FunctionArguments} for the current protocol.
     */
    ...
    /**
     * Creates a new {@code FunctionArguments} for the specified types.
     *
     * @param version the protocol version
     * @param argTypes the argument types
     * @return a new {@code FunctionArguments} for the specified types.
     */
    ...
    /**
     * Creates a new {@code FunctionArguments} that does not deserialize the arguments.
     *
     * @param version the protocol version
    ...
    /**
     * Creates an empty {@code FunctionArguments}.
     *
     * @param version the protocol version
     * @return an empty {@code FunctionArguments}
     */
    ...
    /**
     * Creates a new {@code FunctionArguments} for a native function.
     * <p>Native functions can use different {@code ArgumentDeserializer} to avoid instanciating primitive wrappers.</p>
     *
     * @param version the protocol version
     * @param argTypes the argument types
     * @return a new {@code FunctionArguments} for the specified types.
