...
class CDCSegmentFullException extends InternalRequestExecutionException
{
    ...
    {
        super(RequestFailureReason.CDC_SEGMENT_FULL,
              String.format("Rejecting Mutation containing CDC-enabled table. Free up space in %s.", DatabaseDescriptor.getCDCLogLocation()));
    }
}
