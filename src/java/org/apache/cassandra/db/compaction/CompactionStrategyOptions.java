...
public class CompactionStrategyOptions
{
    ...
    public CompactionStrategyOptions(Class<? extends CompactionStrategy> klass, Map<String, String> options, boolean throwOnInvalidOption)
    {
        ...
        ConfigurationException err = null;
        try
        {
        ...
        tombstoneThreshold = Float.parseFloat(getOption(TOMBSTONE_THRESHOLD_OPTION, err, DEFAULT_TOMBSTONE_THRESHOLD));
        tombstoneCompactionInterval = Long.parseLong(getOption(TOMBSTONE_COMPACTION_INTERVAL_OPTION, err, DEFAULT_TOMBSTONE_COMPACTION_INTERVAL));
        uncheckedTombstoneCompaction = Boolean.parseBoolean(getOption(UNCHECKED_TOMBSTONE_COMPACTION_OPTION, err, DEFAULT_UNCHECKED_TOMBSTONE_COMPACTION_OPTION));
        logAll = Boolean.parseBoolean(getOption(LOG_ALL_OPTION, err, DEFAULT_LOG_ALL_OPTION));
    }
    ...
    private String getOption(String optionName, Throwable err, String defaultValue)
    {
        if (err != null)
            return defaultValue;
