...
public class OpOrderSimple implements OpOrder
{
     ...
     * that they are blocking forward progress. See {@link OpOrderSimple} for idiomatic usage.
     */
    public final class Barrier implements OpOrder.Barrier
    {
        ...
        public boolean isAfter(OpOrder.Group group)
        {
            ...
            // take care of itself
            return orderOnOrBefore.id - ((Group) group).id >= 0;
        }
        ...
        public void issue()
        {
            ...
            synchronized (OpOrderSimple.this)
            {
                ...
                OpOrderSimple.this.current = current.next = new Group(current);
            }
            current.expire();
        }
