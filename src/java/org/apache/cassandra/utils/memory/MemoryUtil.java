...
public abstract class MemoryUtil
{
    ...
    public static final Class<?> DIRECT_BYTE_BUFFER_CLASS, RO_DIRECT_BYTE_BUFFER_CLASS;
    ...
    {
        assert buffer.getClass() == DIRECT_BYTE_BUFFER_CLASS || buffer.getClass() == RO_DIRECT_BYTE_BUFFER_CLASS : buffer.getClass();
