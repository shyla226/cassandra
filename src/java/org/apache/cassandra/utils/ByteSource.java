...
public interface ByteSource
{
     ...
     */
    static ByteSource of(ByteBuffer buf, ByteComparable.Version version)
    {
        if (buf.isDirect())
    ...
    static ByteSource of(String s, ByteComparable.Version version)
    {
     ...
     *      A0B0               4100FF4200FE (+00 for OSS41)
     *      A0                 4100FE       (+00 for OSS41)
     *
     ...
     *
     * See also : https://docs.google.com/document/d/1X9S69gh2-qkb5DyWOFtu-DAr4tBKtzmGJP-Glr8uKL8/edit
     */
    static abstract class AbstractReinterpreter implements ByteSource
    {
        ...
        AbstractReinterpreter(int position, ByteComparable.Version version)
        {
    ...
    static class BufferReinterpreter extends AbstractReinterpreter
    {
        ...
        BufferReinterpreter(ByteBuffer buf, ByteComparable.Version version)
        {
    ...
    /**
     * Variable-length encoding. Escapes 0s as ESCAPE + zero or more ESCAPED_0_CONT + ESCAPED_0_DONE.
     * Finishes in ESCAPE or ESCAPE_0_CONT
     * E.g. A00B translates to 4100FEFF4200
     *      A0B0               4100FF4200FE (+00 for OSS41)
     *      A0                 4100FE       (+00 for OSS41)
     *
     ...
     * because any permitted separator byte will be smaller than the byte following the prefix.
     */
    static class ReinterpreterArray implements ByteSource
    {
        final byte[] buf;
        final ByteComparable.Version version;
        int bufpos = 0;
        ...
        ReinterpreterArray(byte[] buf, ByteComparable.Version version)
        {
            this.buf = buf;
            this.version = version;
        }
