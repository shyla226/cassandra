...
public enum SizeUnit
{
    BYTES("B")
    {
        ...
        public long toKiloBytes(long s) { return s/(C1/C0); }
        public long toMegaBytes(long s) { return s/(C2/C0); }
        public long toGigaBytes(long s) { return s/(C3/C0); }
        public long toTeraBytes(long s) { return s/(C4/C0); }
    },
    KILOBYTES("kB")
    {
        public long convert(long s, SizeUnit u) { return u.toKiloBytes(s); }
        public long toBytes(long s)     { return x(s, C1/C0, MAX/(C1/C0)); }
        public long toKiloBytes(long s) { return s; }
        public long toMegaBytes(long s) { return s/(C2/C1); }
        public long toGigaBytes(long s) { return s/(C3/C1); }
        public long toTeraBytes(long s) { return s/(C4/C1); }
    },
    MEGABYTES("MB")
    {
        public long convert(long s, SizeUnit u) { return u.toMegaBytes(s); }
        public long toBytes(long s)     { return x(s, C2/C0, MAX/(C2/C0)); }
        public long toKiloBytes(long s) { return x(s, C2/C1, MAX/(C2/C1)); }
        public long toMegaBytes(long s) { return s; }
        public long toGigaBytes(long s) { return s/(C3/C2); }
        public long toTeraBytes(long s) { return s/(C4/C2); }
    },
    GIGABYTES("GB")
    {
        public long convert(long s, SizeUnit u) { return u.toGigaBytes(s); }
        public long toBytes(long s)     { return x(s, C3/C0, MAX/(C3/C0)); }
        public long toKiloBytes(long s) { return x(s, C3/C1, MAX/(C3/C1)); }
        public long toMegaBytes(long s) { return x(s, C3/C2, MAX/(C3/C2)); }
        public long toGigaBytes(long s) { return s; }
        public long toTeraBytes(long s) { return s/(C4/C3); }
    },
    TERABYTES("TB")
    {
        public long convert(long s, SizeUnit u) { return u.toTeraBytes(s); }
        public long toBytes(long s)     { return x(s, C4/C0, MAX/(C4/C0)); }
        public long toKiloBytes(long s) { return x(s, C4/C1, MAX/(C4/C1)); }
        public long toMegaBytes(long s) { return x(s, C4/C2, MAX/(C4/C2)); }
        public long toGigaBytes(long s) { return x(s, C4/C3, MAX/(C4/C3)); }
