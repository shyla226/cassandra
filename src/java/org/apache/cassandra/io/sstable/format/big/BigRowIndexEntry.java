 ...
 * </p>
 * <ul>
 *     <li>{@link BigRowIndexEntry} just stores the offset in the data file.</li>
...
public class BigRowIndexEntry extends RowIndexEntry
{
     ...
     * @param indexFilePosition position in the {@link org.apache.cassandra.io.sstable.Component.Type#PRIMARY_INDEX} of the {@link BigRowIndexEntry}
     * @param deletionTime      deletion time of {@link BigRowIndexEntry}
     * @param headerLength      deletion time of {@link BigRowIndexEntry}
     * @param columnIndexCount  number of {@link IndexInfo} entries in the {@link BigRowIndexEntry}
     ...
     */
    public static BigRowIndexEntry create(long dataFilePosition, long indexFilePosition,
    ...
    {
        void serialize(BigRowIndexEntry rie, DataOutputPlus out, ByteBuffer indexInfo) throws IOException;
        BigRowIndexEntry deserialize(DataInputPlus in, long indexFilePosition) throws IOException;
        void serializeForCache(BigRowIndexEntry rie, DataOutputPlus out) throws IOException;
        BigRowIndexEntry deserializeForCache(DataInputPlus in) throws IOException;
