...
public class PerRangeReducingKeyIterator implements KeyIterator
{
    ...
    private final Collection<AbstractBounds<Token>> bounds;
    private int current = -1;
    private int next = -1;

    public PerRangeReducingKeyIterator(Collection<SSTableReader> sstables, Collection<AbstractBounds<Token>> bounds)
    {
    ...
    public Collection<AbstractBounds<Token>> getBounds()
    {
        return bounds;
    }

    private void initIterators(Collection<SSTableReader> sstables, Collection<AbstractBounds<Token>> bounds)
    {
        Iterator<AbstractBounds<Token>> boundsIt = bounds.iterator();
        int idx = 0;
