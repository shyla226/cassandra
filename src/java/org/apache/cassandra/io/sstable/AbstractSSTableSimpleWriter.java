...
abstract class AbstractSSTableSimpleWriter implements Closeable
{
    ...
    protected AbstractSSTableSimpleWriter(File directory, TableMetadata metadata, RegularAndStaticColumns columns)
    {
    ...
    {
        return getUpdateFor(metadata.partitioner.decorateKey(key));
    }
