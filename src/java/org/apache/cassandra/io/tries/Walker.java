...
public class Walker<Concrete extends Walker<Concrete>> implements AutoCloseable
{
    ...
    public <ResType> ResType prefix(ByteSource key, Extractor<ResType, Concrete> extractor)
    {
     ...
     */
    @SuppressWarnings("unchecked")
    public <ResType> ResType prefixAndNeighbours(ByteSource key, Extractor<ResType, Concrete> extractor)
    {
        ResType payload = null;
        greaterBranch = -1;
        lesserBranch = -1;
