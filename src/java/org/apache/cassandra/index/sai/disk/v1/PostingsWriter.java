...
public class PostingsWriter implements Closeable
{
    ...
    private final IntArrayList blockMaxIDs = new IntArrayList();
    private final RAMIndexOutput inMemoryOutput = new RAMIndexOutput("blockOffsets");

    private final long startOffset;

    private int bufferUpto;
    private int lastSegmentRowId;
    private int maxDelta;

    PostingsWriter(IndexComponents components) throws IOException
    {
    ...
    PostingsWriter(IndexComponents components, int blockSize) throws IOException
    {
        this(components.createOutput(components.postingLists, true), blockSize);
    }
    ...
    private void writePosting(int segmentRowId) throws IOException
    {
        ...
        final int delta = segmentRowId - lastSegmentRowId;
    ...
    private void addBlockToSkipTable(int maxSegmentRowID)
    {
    ...
    private void writePostingsBlock(int maxValue, int blockSize) throws IOException
    {
