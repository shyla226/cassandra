...
public class MemtableTermsIterator implements TermsIterator
{
    ...
    private final Iterator<Pair<ByteBuffer, IntArrayList>> iterator;

    private Pair<ByteBuffer, IntArrayList> current;
    ...
    public MemtableTermsIterator(ByteBuffer minTerm,
                                 ByteBuffer maxTerm,
                                 Iterator<Pair<ByteBuffer, IntArrayList>> iterator)
    {
