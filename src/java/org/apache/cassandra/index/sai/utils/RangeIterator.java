 ...
 */
public abstract class RangeIterator extends AbstractIterator<Comparable> implements Closeable
{
    ...
    public RangeIterator(Comparable min, Comparable max, long count)
    {
    ...
    public final Comparable getMinimum()
    {
        return min;
    }

    public final Comparable getCurrent()
    {
        return current;
    }

    public final Comparable getMaximum()
    {
        return max;
    }
     ...
     */
    public final Comparable skipTo(Comparable nextToken)
    {
    ...
    protected abstract void performSkipTo(Comparable nextToken);

    protected Comparable recomputeNext()
    {
    ...
    public static abstract class Builder
    {
        ...
        public static class EmptyRangeIterator extends RangeIterator
        {
            ...
            public Comparable computeNext() { return endOfData(); }
     ...
     */
    @VisibleForTesting
    protected static boolean isOverlapping(Comparable min, Comparable max, RangeIterator b)
    {
