...
public class SimpleRangeUnionIterator extends RangeIterator
{
    ...
    public static SimpleRangeUnionIterator.Builder builder()
    {
        return new SimpleRangeUnionIterator.Builder();
    }

    public static RangeIterator build(List<RangeIterator> tokens)
    {
        return new SimpleRangeUnionIterator.Builder().add(tokens).build();
    }
    ...
    {
        logger.info("[QUERY_TRACE][SimpleRangeUnionIterator:" + size + "] " + message);
    }
}
