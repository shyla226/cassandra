...
public class CassandraLoginModule implements LoginModule
{
    ...
    private void authenticate()
    {
        ...
        // DB-412: we need to repeat the PasswordAuthenticator credentials validation because the DSE authenticator assumes
        ...
        if (!DatabaseDescriptor.getAuthManager().canLogin(user.getLoginRole()).blockingGet())
