...
public class DataResource implements IResource
{
    ...
    private static final Set<Permission> TABLE_LEVEL_PERMISSIONS = Permissions.immutableSetOf(CorePermission.ALTER,
                                                                                              CorePermission.DROP,
    ...
    private static final Set<Permission> KEYSPACE_LEVEL_PERMISSIONS = Permissions.immutableSetOf(CorePermission.CREATE,
