 ...
 *
 * This class is nearly identical to {@link com.codahale.metrics.EWMA}, except that it allows the counter
 * of uncounted updates to be kept externally by setting the <b>keepCount</b> flag to <b>false</b> on construction,
 * and using {@link this#tick(long)} to tick the <b>EWMA</b> with the number of updates since last tick.
 *
 */
public class EWMA
{
    ...
    public static EWMA oneMinuteEWMA(boolean keepCount) {
        return new EWMA(M1_ALPHA, INTERVAL, TimeUnit.SECONDS, keepCount);
    }
    ...
    public static EWMA fiveMinuteEWMA(boolean keepCount) {
        return new EWMA(M5_ALPHA, INTERVAL, TimeUnit.SECONDS, keepCount);
    }
    ...
    public static EWMA fifteenMinuteEWMA(boolean keepCount) {
        return new EWMA(M15_ALPHA, INTERVAL, TimeUnit.SECONDS, keepCount);
    }
     ...
     * @param keepCount whether a {@link LongAdder} must be initialized to keep
     *                  track of uncounted updates since last tick. When this
     *                  is set to false, {@link this#tick()} is unsupported.
     */
     ...
     * @throws UnsupportedOperationException if this {@link EWMA} was created with
     * disabled counter (<b>keepCount</b> constructor parameter set to <b>false</b>).
     */
    ...
    public void tick() {
        if (uncounted == null)
            throw new UnsupportedOperationException();
        tick(uncounted.sumThenReset());
    }

    /**
     * Mark the passage of time and decay the current rate accordingly.
     *
     * @param count the number of uncounted updates since last tick
     */
