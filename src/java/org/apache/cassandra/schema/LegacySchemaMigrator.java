...
public final class LegacySchemaMigrator
{
                                                  ...
                                                  UntypedResultSet triggerRows)
    {
        ...
        Iterable<UntypedResultSet.Row> filteredColumnRows = !isDense && (rawIsDense == null || rawIsDense)
                                                          ? filterOutRedundantRows(columnRows, isSuper, isCompound)
                                                          : columnRows;
    ...
    private static Iterable<UntypedResultSet.Row> filterOutRedundantRows(UntypedResultSet columnRows, boolean isSuper, boolean isCompound)
    {
