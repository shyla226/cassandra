...
public class MigrationManager
{
    ...
    private static void maybeScheduleSchemaPull(UUID theirVersion, InetAddress endpoint, String reason)
    {
        ...
        {
            logger.debug("Not pulling schema from {} due to {}, because shouldPullSchemaFrom returned false",
                         endpoint,
                         reason);
            return;
        }
        ...
        else
        {
            ...
            Runnable runnable = () ->
            {
                ...
                logger.debug("Submitting migration task for {} due to {}, schema version mismatch: local/real={}, local/compatible={}, remote={}",
                             endpoint,
                             reason,
                             Schema.schemaVersionToString(Schema.instance.getRealVersion()),
                             Schema.schemaVersionToString(Schema.instance.getAltVersion()),
