...
public class NativeTransportService
{
    ...
    public static final int NUM_NETTY_THREADS = 15; //Integer.valueOf(System.getProperty("io.netty.eventLoopThreads", String.valueOf(FBUtilities.getAvailableProcessors() * 2)));
