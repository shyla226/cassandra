...
public class ListFrozenCollectionTest extends IndexingTypeSupport
{
    ...
    {
        DataSet<List<Integer>> frozen = new CollectionDataSet.FrozenListDataSet<>(random, new DataSet.IntDataSet(random));
        return generateParameters(new CollectionDataSet.ListDataSet<>(random, frozen));
    }
