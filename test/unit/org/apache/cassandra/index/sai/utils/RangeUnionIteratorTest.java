...
public class RangeUnionIteratorTest extends AbstractRangeIteratorTest
{
    ...
    public void testUnionOfIntersection()
    {
        ...
        assertEquals(LongIterator.convert(), LongIterator.convert(union));
        ...
        assertEquals(LongIterator.convert(2L, 3L, 7L, 8L), LongIterator.convert(union));
        ...
        union = buildUnion(intersectionA, intersectionB);
        assertEquals(LongIterator.convert(2L, 3L), LongIterator.convert(union));
    }
