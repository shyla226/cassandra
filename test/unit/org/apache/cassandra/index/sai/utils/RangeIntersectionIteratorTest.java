...
public class RangeIntersectionIteratorTest extends AbstractRangeIteratorTest
{
    ...
    {
        for (RangeIntersectionIterator.Strategy strategy : RangeIntersectionIterator.Strategy.values())
            testNoOverlappingValues(strategy);
    }

    private void testNoOverlappingValues(RangeIntersectionIterator.Strategy strategy)
    {
        RangeIterator.Builder builder = RangeIntersectionIterator.builder(strategy);
    ...
    private void testOverlappingValues(RangeIntersectionIterator.Strategy strategy)
    {
        RangeIterator.Builder builder = RangeIntersectionIterator.builder(strategy);
    ...
    private void testSingleIterator(RangeIntersectionIterator.Strategy strategy)
    {
        RangeIntersectionIterator.Builder builder = RangeIntersectionIterator.builder(strategy);
    ...
    private void testSkipTo(RangeIntersectionIterator.Strategy strategy)
    {
        RangeIterator.Builder builder = RangeIntersectionIterator.builder(strategy);
    ...
    private void testMinMaxAndCount(RangeIntersectionIterator.Strategy strategy)
    {
        RangeIterator.Builder builder = RangeIntersectionIterator.builder(strategy);
    ...
    private void testBuilder(RangeIntersectionIterator.Strategy strategy)
    {
        RangeIterator.Builder builder = RangeIntersectionIterator.builder(strategy);
    ...
    private void testClose(RangeIntersectionIterator.Strategy strategy) throws IOException
    {
        RangeIterator tokens = RangeIntersectionIterator.builder(strategy)
    ...
    private void testIntersectionOfRandomRanges(RangeIntersectionIterator.Strategy strategy)
    {
    ...
    public void testIteratorPeeking()
    {
        ...
        RangeIterator intersection = builder.build();

        Assert.assertNotNull(intersection);
        Assert.assertEquals(RangeIntersectionIterator.LookupIntersectionIterator.class, intersection.getClass());
        ...
        Assert.assertNotNull(intersection);
        Assert.assertEquals(RangeIntersectionIterator.BounceIntersectionIterator.class, intersection.getClass());
    ...
    public void testMergingSameToken()
    {
        ...
        assertEquals(LongIterator.convert(-3L, 3L, 9L), LongIterator.convertOffsets(intersection));
    }
    ...
    public void testSelectiveIntersection()
    {
        ...
        assertEquals(LongIterator.convert(1L, 4L, 6L), LongIterator.convert(intersection));
        ...
        assertEquals(LongIterator.convert(2L, 4L, 6L), LongIterator.convert(intersection));
    }
