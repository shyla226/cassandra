...
public class SimpleRangeUnionIteratorTest extends AbstractRangeIteratorTest
{
    @Test
    ...
    public void testBuilder()
    {
        ...
        Iterator<RangeIterator> iterator = builder.simpleRanges.iterator();
        Assert.assertEquals(1L, (long) iterator.next().getMinimum());
        Assert.assertEquals(4L, (long) iterator.next().getMinimum());
        Assert.assertEquals(7L, (long) iterator.next().getMinimum());

        RangeIterator tokens = SimpleRangeUnionIterator.build(new ArrayList<RangeIterator>()
        {{
        ...
        RangeIterator emptyTokens = SimpleRangeUnionIterator.builder().build();
        Assert.assertEquals(0, emptyTokens.getCount());

        builder = SimpleRangeUnionIterator.builder();
    ...
    {
        SimpleRangeUnionIterator.Builder builderA = SimpleRangeUnionIterator.builder();

        builderA.add(new LongIterator(new long[] { 1L, 3L, 5L }));
        builderA.add(new LongIterator(new long[] { 8L, 10L, 12L }));

        SimpleRangeUnionIterator.Builder builderB = SimpleRangeUnionIterator.builder();

        builderB.add(new LongIterator(new long[] { 7L, 9L, 11L }));
        builderB.add(new LongIterator(new long[] { 2L, 4L, 6L }));

        RangeIterator union = SimpleRangeUnionIterator.build(Arrays.asList(builderA.build(), builderB.build()));
    ...
    public void testUnionOfIntersection()
    {
        ...
        assertEquals(SimpleRangeUnionIterator.class, union.getClass());
    ...
    {
        return SimpleRangeUnionIterator.builder().add(Arrays.asList(ranges)).build();
    }
}