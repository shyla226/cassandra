...
public class MergePostingListTest extends NdiRandomizedTest
{
    ...
    {
        final List<PostingList> lists = newArrayList(new ArrayPostingList(new int[]{ 1, 4, 6 }));
    ...
    {
        final List<PostingList> lists = newArrayList(new ArrayPostingList(new int[]{ 0 }),
    ...
    {
        final List<PostingList> lists = newArrayList(new ArrayPostingList(new int[]{ 1, 1, 2, 2, 2, 2, 5, 5 }),
    ...
    private void testAdvancingOnRandom() throws IOException
    {
        ...
        {
            int expectedResult = action.advance(expected);
            int actualResult = action.advance(merge);
