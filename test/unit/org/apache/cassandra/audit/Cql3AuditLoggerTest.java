...
public class Cql3AuditLoggerTest extends CQLTester
{
            ...
            throws Exception
    {
        ...
        // we also need the bound column specs, which DseQueryHandler has cached for us
        List<ColumnSpecification> boundNames = PreparedStatementCache.instance.getQueryInfo(stmt).right;
