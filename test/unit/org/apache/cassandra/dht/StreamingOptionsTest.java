...
public class StreamingOptionsTest
{
    ...
    {
        assertErrorOnForRebuild("At least one of the " + StreamingOptions.ARG_INCLUDE_SOURCES
                                + ", " + StreamingOptions.ARG_EXCLUDE_SOURCES
                                + ", " + StreamingOptions.ARG_INCLUDE_DC_NAMES
                                + ", " + StreamingOptions.ARG_EXCLUDE_DC_NAMES
        ...
        assertErrorOnForRebuild("At least one of the " + StreamingOptions.ARG_INCLUDE_SOURCES
                                + ", " + StreamingOptions.ARG_EXCLUDE_SOURCES
                                + ", " + StreamingOptions.ARG_INCLUDE_DC_NAMES
                                + ", " + StreamingOptions.ARG_EXCLUDE_DC_NAMES + " (or src-dc-name) arguments must be specified for rebuild.",
                                null, null, null, null);
