...
public class SelectGroupByTest extends CQLTester
{
    ...
    public void testGroupByTimeRangesWithoutPaging() throws Throwable
    {
        ...
        createTable("CREATE TABLE %s (pk int, time timeuuid, v int, primary key (pk, time))");
        ...
        // Test with time type.
        createTable("CREATE TABLE %s (pk int, date date, time time, v int, primary key (pk, date, time))");
    ...
    {
        long timeInMillis = DateTimeFormat.forPattern("yyyy-MM-dd HH:mm:ss")
                                          .withZone(DateTimeZone.UTC)
                                          .parseDateTime(string)
                                          .getMillis();

        return UUIDGen.getTimeUUID(timeInMillis);
    }
    ...
    {
        return LocalDate.fromMillisSinceEpoch(DateTimeFormat.forPattern("yyyy-MM-dd")
                                                            .withZone(DateTimeZone.UTC)
