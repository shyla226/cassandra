...
public class SelectorSerializationTest extends CQLTester
{
    ...
    public void testSerDes() throws IOException
    {
        ...
        checkSerialization(new Selectable.WritetimeOrTTL(column, column, true), table);
        checkSerialization(new Selectable.WritetimeOrTTL(column, column, false), table);
        ...
        Pair<Selectable.Raw, Selectable.Raw> pair = Pair.<Selectable.Raw, Selectable.Raw>create(ColumnMetadata.Raw.forColumn(table.getColumn(new ColumnIdentifier("v", false))),
                                                                                                ColumnMetadata.Raw.forColumn(table.getColumn(new ColumnIdentifier("c1", false))));
        ...
        List<Pair<Selectable.Raw, Selectable.Raw>> list = asList(Pair.<Selectable.Raw, Selectable.Raw>create(RawIdentifier.forUnquoted("f1"),
                                                                 ...
                                                                 Pair.<Selectable.Raw, Selectable.Raw>create(RawIdentifier.forUnquoted("f2"),
                                                                                                             ColumnMetadata.Raw.forColumn(table.getColumn(new ColumnIdentifier("pk", false)))));
    ...
    {
        Serializer serializer = Selector.serializers.get(ReadVersion.DSE_60);
