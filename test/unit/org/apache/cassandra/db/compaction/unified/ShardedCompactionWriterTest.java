...
public class ShardedCompactionWriterTest extends CQLTester
{
    ...
    public void testOneSSTablePerShard() throws Throwable
    {
        ...
        testShardedCompactionWriter(numShards, rowCount, minSSTableSizeRatio, numShards);
    }
    ...
    public void testOneSSTableOnly() throws Throwable
    {
        ...
        testShardedCompactionWriter(numShards, rowCount, minSSTableSizeRatio, 1);
    }
    ...
    public void testThreeSSTables() throws Throwable
    {
        ...
        testShardedCompactionWriter(numShards, rowCount, minSSTableSizeRatio, 3);
    }

    private void testShardedCompactionWriter(int numShards, int rowCount, double minSSTableSizeRatio, int numOutputSSTables) throws Throwable
    {
        ...
        CompactionAwareWriter writer = new ShardedCompactionWriter(cfs, cfs.getDirectories(), txn, txn.originals(), false, minSSTableSize, boundaries);
