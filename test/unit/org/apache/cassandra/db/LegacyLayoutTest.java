...
public class LegacyLayoutTest
{
    ...
    public void testRTForRegularComplex() throws Throwable
    {
        ...
        Row.Builder builder = BTreeRow.unsortedBuilder(0);
        builder.newRow(Clustering.make(INT_1, INT_2));
    ...
    public void testRTForRow() throws Throwable
    {
        ...
        upd.add(updateParameters.makeRangeTombstone(Slice.make(ClusteringBound.exclusiveStartOf(INT_2),
                                                               ClusteringBound.inclusiveEndOf(INT_2))));
