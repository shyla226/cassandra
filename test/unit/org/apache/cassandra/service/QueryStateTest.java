...
public class QueryStateTest
{
    ...
    public static class TestAuthorizer implements IAuthorizer
    {
        ...
        public Map<IResource, PermissionSets> fetchRolePermissionsOnResources(Collection<? extends IResource> resources, RoleResource grantee) throws RequestValidationException, RequestExecutionException
        {
            throw new UnsupportedOperationException();
        }
