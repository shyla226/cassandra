...
public class CQLSSTableWriterTest
{
    ...
    private class WriterThread extends Thread
    {
        ...
        public void run()
        {
            ...
            SchemaLoader.load("cql_keyspace2", schema);
            CQLSSTableWriter writer = CQLSSTableWriter.builder()
                    .inDirectory(dataDir)
                    .forTable(schema)
                    .using(insert).build();
    ...
    public void testWritesWithUdts() throws Exception
    {
        ...
        String type1 = "CREATE TYPE " + KS + ".tuple2 (a int, b int)";
        String type2 = "CREATE TYPE " + KS + ".tuple3 (a int, b int, c int)";
        SchemaLoader.load(KS, schema, type1, type2);
        CQLSSTableWriter writer = CQLSSTableWriter.builder()
                                                  .inDirectory(dataDir)
                                                  .withType(type1)
                                                  .withType(type2)
    ...
    public void testWritesWithDependentUdts() throws Exception
    {
        ...
        String type1 = "CREATE TYPE " + KS + ".tuple2 (a int, b int)";
        String type2 = "CREATE TYPE " + KS + ".nested_tuple (c int, tpl frozen<tuple2>)";
        SchemaLoader.load(KS, schema, type1, type2);
        CQLSSTableWriter writer = CQLSSTableWriter.builder()
                                                  .inDirectory(dataDir)
                                                  .withType(type1)
