...
public class TrieIndexSSTableWriterTest extends AbstractTransactionalTest
{
    ...
    private static class TestableBTW extends TestableTransaction
    {
        ...
        {
            assertExists(Component.DATA, Component.PARTITION_INDEX, Component.ROW_INDEX);
        ...
        {
            assertNotExists(Component.DATA, Component.PARTITION_INDEX, Component.ROW_INDEX);
