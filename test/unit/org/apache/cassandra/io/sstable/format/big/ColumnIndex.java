 ...
 * this uses the serialization logic as in {@link BigRowIndexEntry}.
 */
public class ColumnIndex
{
                        ...
                        ISerializer<IndexInfo> indexInfoSerializer)
    {
        this.header = header;
        this.writer = writer;
        this.serializer = UnfilteredSerializer.serializers.get(version.encodingVersion());
    ...
    private void writePartitionHeader(UnfilteredRowIterator iterator) throws IOException
    {
        ...
        if (header.hasStatic())
        {
            ...
            serializer.serializeStaticRow(staticRow, header, writer);
    ...
    private void add(Unfiltered unfiltered) throws IOException
    {
        ...
        serializer.serialize(unfiltered, header, writer, pos - previousRowStart);
    ...
    {
        serializer.writeEndOfPartition(writer);
        ...
        if (buffer != null)
            BigRowIndexEntry.Serializer.serializeOffsets(buffer, indexOffsets, columnIndexCount);
