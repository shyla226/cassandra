...
public abstract class CassandraAuditWriterTester extends CQLTester
{
    ...
    public void testEventLoggingWithSimpleQueries() throws Throwable
    {
        ...
        assertRows(fetchAuditEvents(),
                   ...
                   row("UNAUTHORIZED_ATTEMPT", CassandraAuditKeyspace.NAME, CassandraAuditKeyspace.AUDIT_LOG, "blake", "User blake has no SELECT permission on <table cassandra_audit.audit_log> or any of its parents SELECT * FROM cassandra_audit.audit_log"),
    ...
    public void testEventLoggingWithPreparedQueries() throws Throwable
    {
        ...
        assertRows(fetchAuditEvents(),
                   ...
                   row("CQL_PREPARE_STATEMENT", CassandraAuditKeyspace.NAME, CassandraAuditKeyspace.AUDIT_LOG, "benjamin", "SELECT * FROM cassandra_audit.audit_log"),
                   row("UNAUTHORIZED_ATTEMPT", CassandraAuditKeyspace.NAME, CassandraAuditKeyspace.AUDIT_LOG, "benjamin", "User benjamin has no SELECT permission on <table cassandra_audit.audit_log> or any of its parents SELECT * FROM cassandra_audit.audit_log"),
