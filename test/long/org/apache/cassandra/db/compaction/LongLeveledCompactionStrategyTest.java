...
public class LongLeveledCompactionStrategyTest
{
    ...
    public void testParallelLeveledCompaction() throws Exception
    {
        ...
        LeveledCompactionStrategy repaired = (LeveledCompactionStrategy) store.getCompactionStrategyManager().getStrategies().get(0).get(0);
        LeveledCompactionStrategy unrepaired = (LeveledCompactionStrategy) store.getCompactionStrategyManager().getStrategies().get(1).get(0);
